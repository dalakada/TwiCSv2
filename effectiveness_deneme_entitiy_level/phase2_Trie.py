...
class EntityResolver ():
    ...
    def executor(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold,raw_tweets_for_others):
        ...
        #recording tp, fp , f1
        self.accuracy_tuples_prev_batch.append((just_converted_tweets.iloc[0]['tp'], just_converted_tweets.iloc[0]['total_mention'],just_converted_tweets.iloc[0]['fp'],just_converted_tweets.iloc[0]['fn']))
    ...
    def finish(self):
        return self.accuracy_vals,self.accuracy_vals_stanford,self.accuracy_vals_ritter,self.accuracy_vals_opencalai

    def finish_other_systems(self):

        print("*****************************************OUR RESULSTSSS***********************")
        for idx,i in enumerate(self.accuracy_vals_stanford):
            print("F1", i[0])
            print("Precision", i[1])
            print("Recall", i[0])


        print("*****************************************OUR ENDSSSSSSSS***********************")
        ...
        print("*****************************************RITTER ENDSSSSSSSS***********************")
        print("*****************************************OPENCALAI RESULSTSSS***********************")
        for i in self.accuracy_vals_opencalai:
            print("F1", i[0])
            print("Precision", i[1])
            print("Recall", i[0])

        print("*****************************************OPENCALAI ENDSSSSSSSS***********************")
