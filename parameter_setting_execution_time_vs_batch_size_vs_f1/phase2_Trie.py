...
class EntityResolver ():
    ...
    def classify_candidate_base(self,z_score_threshold,candidate_featureBase_DF):
        ...
        return self.my_classifier.run(candidate_featureBase_DF,z_score_threshold)
    ...
    def executor(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold):
        ...
        candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder = self.extract(TweetBase,CTrie,phase2stopwordList,z_score_threshold)
        #set ['probabilities'] for candidate_featureBase_DF
        candidate_featureBase_DF= self.classify_candidate_base(z_score_threshold,candidate_featureBase_DF)
        ...
        self.incomplete_tweets,just_converted_tweets_for_current_batch,untrashed_tweets=self.get_incomplete_tweets_frame(data_frame_holder,
        ...
        ########
        ########
        #input: incomplete_tweets, candidate_featureBase_DF 
        ...
        # input: incomplete_tweets, .[good_candidates],[annotation]
        ...
        just_converted_tweets=untrashed_tweets[untrashed_tweets.completeness==True]
        self.incomplete_tweets=untrashed_tweets[untrashed_tweets.completeness==False]
    ...
    def calculate_tp_fp_f1(self,z_score_threshold,input_to_eval):
        ...
        if(len(good_candidates)>0):
            ...
            recall=(tp_count)/(tp_count+false_negative_count_IPQ)
            f_measure=2*(precision*recall)/(precision+recall)



            self.accuracy_vals.append((tp_count,tm_count,fp_count,fn_count,f_measure))
    ...
    def get_incomplete_tweets_frame(self,data_frame_holder,candidate_featureBase_DF,phase2_candidates_holder):
        ...
        # mixed_candidates= good_candidates + bad_candidatesget_incomplete_tweets_frame
        ...
        return (data_frame_holder[data_frame_holder.completeness==False],data_frame_holder[data_frame_holder.completeness==True],data_frame_holder)
