...
ax2.text(0.5, 0.10, 'Aguilar et al.',ha='center', va='center', transform=ax2.transAxes,FontProperties=font_legend)
...
# ax3.text(0.8, 0.52, 'Aguilar et al.',ha='center', va='center', transform=ax3.transAxes,FontProperties=font_legend)
