...
class SatadishaModule():
    ...
    def extract(self,batch,batch_number): 
            ...
            for sen_index in range(len(tweetSentenceList)):
                ...
                if((not tweetText.isupper()) &(not tweetText.islower())):
                    ...
                    if(len(ne_List_allCheck)>0):
                        ...
                        gap=curr_index-last_found_index-1
                        if(gap not in self.interCS_gap_dict.keys()):
                            self.interCS_gap_dict[gap]=1
                        else:
                            self.interCS_gap_dict[gap]+=1
                        last_found_index=curr_index
        ...
        return (self.df_out,self.CTrie,time_in,time_out,self.phase2stopWordList,direct_coverage)
