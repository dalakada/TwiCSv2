...
fontPath = "/usr/share/fonts/truetype/abyssinica/AbyssinicaSIL-R.ttf"
font_legend = fm.FontProperties(fname=fontPath, size=20)
...
for idx,level in enumerate(p2_holder_tranpsosed[1:]):
    ...
    legend=plt.legend(loc="upper right",ncol=1,frameon=False,prop=font_legend,title="# of Input Tweets",labels=my_label)
