...
class EntityResolver ():
    ...
    def __init__(self):
        self.counter=0
        self.my_classifier= svm.SVM1('new_training.csv')

    def set_label(self,candidate_featureBase_DF,input_to_eval):
    ...
    def accuracy(self,input_to_eval):
        ...
        if(len(good_candidates)>0):
            ...
            self.accuracy_vals.append(tp_count/tm_count)
        ...
        #input_to_eval.to_csv("incomplete_tweets.csv", sep=',', encoding='utf-8')
    ...
    def get_ratio_for_each_sentence(self):
    ...
    #@profile
    # rp = retention period
    def get_incomplete_tweets_frame(self,
        data_frame_holder,
        ...
        #setting label
        self.set_label(candidate_featureBase_DF,data_frame_holder)

        # accuracy
        data_frame_holder_w_accuracy=self.accuracy(data_frame_holder)


        #return (data_frame_holder_w_accuracy[(data_frame_holder_w_accuracy.completeness==False) & (data_frame_holder_w_accuracy.current_minus_entry<rp)],data_frame_holder_w_accuracy[data_frame_holder_w_accuracy.completeness==True])
        return (data_frame_holder_w_accuracy[(data_frame_holder_w_accuracy.completeness==False)],data_frame_holder_w_accuracy[data_frame_holder_w_accuracy.completeness==True])
    ...
    #@profile
    def extract(self,TweetBase,CTrie,z_score_threshold):
        ...
        if(self.counter==0):
            ...
            #true_positive and total_mention counts from OQs of prev batches
            self.accuracy_tuples_prev_batch=[]
            #just accuracy values till current batch
            self.accuracy_vals=[]
        ...
        #just_converted_tweets_for_current_batch ----> same as self.data_frame_holder_OQ
        self.incomplete_tweets,just_converted_tweets_for_current_batch=self.get_incomplete_tweets_frame(data_frame_holder,candidate_featureBase_DF,phase2_candidates_holder,2)

        just_converted_tweets_for_current_batch.to_csv("complete_ones"+str(self.counter)+".csv", sep=',', encoding='utf-8')
        self.accuracy_tuples_prev_batch.append((just_converted_tweets_for_current_batch.tp.sum(), just_converted_tweets_for_current_batch.total_mention.sum()))
        self.incomplete_tweets.to_csv("incomplete_tweets.csv", sep=',', encoding='utf-8')


        #self.incomplete_tweets=data_frame_holder


        # if(self.counter==61):
            # print(self.accuracy_vals)
        ...
        # accuracy
        # self.get_ratio_for_each_sentence()
