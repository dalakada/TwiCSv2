...
class EntityResolver ():
    ...
    def set_x_axis(self):
        ...
        self.incomplete_tweets["ratio_entry_vs_current"]=self.incomplete_tweets['entry_batch']/self.incomplete_tweets['number_of_seen_tweets']
    ...
    def get_ratio_for_each_sentence(self):
        ...
        if(len(good_candidates)>0):
            for idx,val in enumerate(annotations):
                ...
                print(true_positive_line,'ground truth: ',annotations[idx],'our system: ',good_candidates[idx])
    ...
    def get_incomplete_tweets_frame(self,data_frame_holder,candidate_featureBase_DF,phase2_candidates_holder):
        ...
        return data_frame_holder[data_frame_holder.completeness==False]
    ...
    def extract(self,TweetBase,CTrie,z_score_threshold):
        ...
        for index, row in immediate_processingQueue.iterrows():
            ...
            dict1 = {'entry_batch':int(batch), 'tweetID':tweetID, 'sentID':sentID, 'hashtags':hashtags, 'user':user, 'TweetSentence':tweetText, 'phase1Candidates':phase1Candidates,'2nd Iteration Candidates':phase2_candidates}
        ...
        self.incomplete_tweets=self.get_incomplete_tweets_frame(data_frame_holder,candidate_featureBase_DF,phase2_candidates_holder)
       ...
       #  for i in range(tweetID_holder.max()+1):
       ...
       #      #print(idx,false_positive_line)
       #      print(idx,false_positive_line,'ground truth: ',times_2_holder[idx],'opencalai: ',true_positives_candidates[idx])
