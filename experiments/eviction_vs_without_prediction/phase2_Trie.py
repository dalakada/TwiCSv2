...
class EntityResolver ():
    ...
    def executor(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold,eviction_parameter,classifier):
        ...
        # SET CB
        candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder,correction_flag,time_in,time_out=self.set_cb(TweetBase,CTrie,phase2stopwordList,z_score_threshold,eviction_parameter)
        ...
        self.set_column_for_candidates_in_incomplete_tweets(candidate_featureBase_DF,annotated_tweets)
        print('YARRAAAAAAQ')
    ...
    def set_cb(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold,eviction_parameter):
        ...
        candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder,time_in,time_out = self.extract(TweetBase,CTrie,phase2stopwordList,eviction_parameter)
        ...
        #['probability'],['a,g,b']
        return candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder,correction_flag,time_in,time_out
    ...
    def extract(self,TweetBase,CTrie,phase2stopwordList,eviction_parameter):
        ...
        if(self.counter==0):
            #output_queue
            self.data_frame_holder_OQ=pd.DataFrame([], columns=['index', 'entry_batch', 'tweetID', 'sentID', 'hashtags', 'user', 'TweetSentence','phase1Candidates', '2nd Iteration Candidates','annotation','annotated'])
            self.incomplete_tweets=pd.DataFrame([], columns=['index','entry_batch', 'tweetID', 'sentID', 'hashtags', 'user', 'TweetSentence','phase1Candidates', '2nd Iteration Candidates','annotation','annotated'])
            self.CandidateBase_dict= {}
            self.partition_dict={}
            self.good_candidates=[]
            self.bad_candidates=[]
            self.aggregator_incomplete_tweets=pd.DataFrame([], columns=['index', 'entry_batch', 'tweetID', 'sentID', 'hashtags', 'user', 'TweetSentence','phase1Candidates', '2nd Iteration Candidates','annotation','annotated'])
            self.just_converted_tweets=pd.DataFrame([], columns=['index', 'entry_batch', 'tweetID', 'sentID', 'hashtags', 'user', 'TweetSentence','phase1Candidates', '2nd Iteration Candidates','annotation','annotated'])
        ...
        data_frame_holder=pd.DataFrame([], columns=['index','entry_batch','tweetID', 'sentID', 'hashtags', 'user', 'TweetSentence','phase1Candidates', '2nd Iteration Candidates','annotation','annotated'])
        ...
        for index, row in immediate_processingQueue.iterrows():
            ...
            dict1 = {'entry_batch':batch, 'tweetID':tweetID, 'sentID':sentID, 'hashtags':hashtags, 'user':user, 'TweetSentence':tweetText, 'phase1Candidates':phase1Candidates,'2nd Iteration Candidates':phase2_candidates,'annotation':annotation,'annotated':is_annotated}
        ...
        return candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder,time_in,time_out
