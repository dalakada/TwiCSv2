...
class EntityResolver ():
    ...
    def executor(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold):
        ...
        # SET CB
        candidate_featureBase_DF,data_frame_holder,phase2_candidates_holder=self.set_cb(TweetBase,CTrie,phase2stopwordList,z_score_threshold)
    ...
    def calculate_tp_fp_f1(self,z_score_threshold,input_to_eval):
        ...
        if(len(good_candidates)>0):
            ...
            print('f1 score:', f_measure,'trupe positive: ',tp_count, 'false positive: ',fp_count,'false negative: ', fn_count,'total mentions: ', tm_count)
    ...
    #@profile
    def set_completeness_in_tweet_frame(self,data_frame_holder,candidate_featureBase_DF,phase2_candidates_holder):
