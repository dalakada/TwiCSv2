...
class EntityResolver ():
    ...
    def executor(self,TweetBase,CTrie,phase2stopwordList,z_score_threshold,raw_tweets_for_others):
        ...
        raw_tweets_for_others.to_csv("raw_teets.csv", sep=',', encoding='utf-8')
        ...
        ########
        ########
        annotation_flat=self.get_annotation(z_score_threshold,untrashed_tweets)
        ########
        ########
        ...
        ########
        ########
        self.raw_tweets_for_others.to_csv("raw_teets2.csv", sep=',', encoding='utf-8')
    ...
    def calculate_tp_fp_f1_generic(self,raw_tweets_for_others,state_of_art):
        ...
        for unique_tweetID in unique_tweetIDs:
            ...
            # print(len(group_by_tweet_id_df['TweetSentence']))
            tweet_level_annot=[]
        ...
        my_list=['netherlands', 'rio', 'ca', 'sc', 'unicorns', 'twitter', 'kabuki', 'shashlik rap', 'cantando', 'white privilege', 'sia', 'oakley', 'homophobes', 'clinton', 'barry', 'trumps', 'democrats', 'trump/russia', 'tories', 'yair rodriguez', 'latino', 'healthcare', 'gorilla', 'spicer', 'chuck', 'aca', 'salvador', 'donald', 'lou', 'snakes', 'socialist', 'uber', 'european', 'bbc', 'wh', 'rus', 'fairytale', 'sun', 'republican', 'foreign agent', 'titanium', 'evanescence', 'ireland', 'game of thrones', 'joe', 'president', 'obama', 'justin', 'vodka', 'congressmen', 'democratic', 'reichert', 'bill', 'edgar', 'dana', 'nate', 'electoral college', 'mma', 'uranium', 'senate', 'dt', 'genocide', 'constitution', 'justice', 'kay', 'page', 'africa', 'camila', 'iq', 'morgan freeman', 'whites', 'mike', 'ic', 'institutional racism', 'rocky balboa', 'tb', 'karma', 'euro', 'payne', 'mary', 'kylo ren', 'don', 'pa', 'pro socialism', 'katy', 'rice', 'jj', 'hr', 'zedd', 'mayo', 'aaron', 'house representatives', 'nial', 'potus', 'americans', 'alessia', 'cinnamon roll', 'prince', 'cnn', 'sean', 'senators', 'stipe', 'poc', 'carter', 'phil', 'healthcare bill', 'jim comey', 'session', 'gender studies', 'brit', 'russia', 'cyrus', 'italy', 'kkk', 'america', 'health bill', 'cat', 'ibs', 'tomahawks', 'horan', 'nunes', 'tang', 'malibu', 'stoke', 'coal mining', 'tariq', 'ces', 'yoongi', 'israel', 'representatives', 'cold war', 'm5', 'miley', 'lgbt', 'fisa', 'asha', 'cali', 'hotdogs', 'australia', 'hilary', 'des', 'white supremacists', 'comey', 'conservative', 'united', 'american', 'abortion', 'bananies', 'carter page', 'sam', 'la', 'canonization', 'california', 'jones', 'alexander rybak', 'halsey', 'trump', 'house republicans', 'portuguese', 'islam', 'dm', 'demian', 'earth', 'penicillin', 'military', 'asia', 'sessions', 'turkish', 'joanna', 'texas', 'dem', 'russian', 'african americans', 'townhall', 'sweden', 'american people', 'nsa', 'harry', 'obamacare', 'reps', 'starving', 'red carpet', 'niall', 'racism', 'rodriguez', 'apocalypse', 'death panel', 'ruth', 'commonwealth games', 'eurovision', 'spicy', 'aldo', 'noah', 'europe', 'junior', 'cub swanson', 'moon', 'masvidal', 'armenia', 'tomahawk', 'united kingdom', 'democrat', 'uk', 'rep', 'planned parenthood', 'lp', 'ron', 'health plan', 'congress', 'insulin', 'vegas', 'irs', 'liberals', 'bjj', 'trumpanzees', 'hof', 'instagram', 'daniel', 'civil rights movement', 'libs', 'snapchat', 'nc', "we can't stop", 'computer networking', 'maia', 'scarface', 'house', 'avocadies', 'blair', 'polonium tea syndrome', 'ufc', 'ne', 'us', '2016 presidential campaign', 'liam', 'ed balls', 'fbi', 'turkey', 'yair', 'belgium', 'liberal', 'watergate', 'republicans', 'jesus', 'pantera', 'numb', 'dc', 'the death panel', 'otc', 'chameleon', 'white supremacist', 'ny', 'linkin park', 'carson', 'adam', 'usa', 'foreign policy advisor']
        # my_list=['cyrus', 'miley', 'reichert', 'bill', 'uber', 'scarface', 'aldo', 'instagram', 'president', 'civil rights movement', 'niall cantando', 'whites', 'carter', 'russian intelligence', 'sam', 'australia', 'chameleon', 'ruth', 'genocide', 'm5', 'russia oil', 'senators', 'white supremacists', 'rus', 'karma', 'apocalypse', 'numb', 'socialist', 'bjj', 'justice', 'mma', 'yair rodriguez', 'on the loose', 'rep', 'white privilege', 'ic', 'mike', 'house republicans', 'potus', 'fisa', 'polonium tea syndrome', 'dana', 'latino', 'frankie edgar', 'jj', 'roe v. wade', 'islam', 'american', 'ces', 'penicillin', 'tariq', 'healthcare bill', 'liam e niall', 'house', 'liberal', 'death panel', "we can't stop", 'senate', 'demian maia', 'kkk', 'sweden', 'obama presidency', 'insulin', 'edgar', 'america', 'the korean peninsula', 'white supremacist', 'spicy', 'texas', 'yair', 'dem', 'chuck', 'asia', 'gender studies', 'brazilian fighters', 'junior', 'earth', 'united kingdom', 'asha', 'adam', 'health plan', 'maroon 5', 'americans', 'joe', 'nunes', 'liberals', 'turkish', 'turkey', 'republicans', 'ufc', 'poc', 'civil war', 'morgan freeman', 'jones', 'type 1 diabetics', 'townhall', 'otc', 'portuguese', 'united states of west america', 'institutional racism', 'vegas', 'fbi', 'red carpet', 'lou', 'eurovision', 'gorilla', 'united states of flyover america', 'cali', 'bbc', 'trump', 'kay', 'house representatives', 'evanescence', 'netherlands', 'starving', 'russian agent', 'iq', 'trumps', 'commonwealth games', 'noah', 'syria strike', 'hr', 'planned parenthood', 'jim comey', 'nc', 'titanium', 'game of thrones', 'military', 'act 1871', 'maia', 'representatives', 'irs', 'the death panel', 'obamacare', 'yoongi', 'health bill', 'tower of babel', 'david guetta', 'payne', 'belgium', 'tomahawks', 'donald', 'brit', 'rice', 'constitution', 'democrats', 'sun', 'africa', 'carson', 'snapchat', 'halsey', 'ed balls', 'racism', 'native americans', 'united', 'rodriguez', 'sessions', 'daniel', 'moon', 'camila', 'carter page', '2016 presidential campaign', 'ron', 'russia', 'united states of  east america', 'armenia', 'libs', 'house of representatives', 'katy', 'sean', 'trumpanzees', 'linkin park', 'tb', 'avocadies', 'nial', 'session', 'pa', 'malibu', 'vodka', 'sc', 'harry', 'tang', 'obama', 'cantando', 'russian', 'salvador', 'trump/russia', 'scared to be lonely', 'bananies', 'ibs', 'zedd', 'europe', 'rio', 'canonization', 'masvidal', 'lp', 'american people', 'reps', 'ireland', 'mayo', 'nate', 'phil', 'pro socialism', 'hof', 'kylo ren', 'blair', 'nsa', 'democrat', 'don', 'mary', 'niall', 'stipe', 'european', 'obama admin', 'cat', 'prince', 'us', 'euro', 'aca', 'tomahawk', 'lgbt', 'cnn', 'justin', 'tories', 'may 13', 'usa', 'joanna', 'italy', 'kabuki', 'california', 'frankie ed', 'twitter', 'shashlik rap', 'page', 'cub swanson', 'demian', 'hilary', 'republican party', 'watergate', 'horan', 'dt', 'uk', 'des', 'computer networking', 'barry', 'congress', 'sia', 'rocky balboa', 'israel', 'aaron', 'dc', 'pantera', 'nov 2018', 'liam', 'comey', 'ny', 'spicer', 'la', 'russian government', 'healthcare', 'abortion', 'wh', 'african americans', 'cold war', 'alessia', 'stoke', 'democratic', 'jesus', 'alexander rybak', 'unicorns', 'electoral college', 'ca', 'uranium', 'dm', 'ne', 'clinton', 'oakley', 'republican', 'american government']
        # my_list=['hrc', 'lord vader', 'sbs', 'himmel och hav', 'flint', 'amanda', 'adm levine', 'las vegas', 'holocaust denier', 'asian', 'nonsense karaoke', 'gignac', 'croatia', 'western cape', 'james bond', 'putin', 'chase sherman', 'house passage', 'mercedes', 'amar pelos dois', 'kyiv', 'malta', 'nyc', 'copa del rey', 'passover', 'sherdog forums', 'lbj', 'måns', 'costarica', 'chipmunk', 'slovenia', 'carl', 'migos', 'gop republicans', 'female genital mutilation', 'odessa', 'iraw war', 'paul manafort', 'royce', 'liam payne', 'cankles', 'crips', 'united airlines', 'mayonnaise', 'house health bill', 'brad pitt', 'anna wintour', 'italian', 'baywatch', 'sax', 'wales', 'dq', 'holocaust', 'liberalism', 'mlk', 'sorosian', 'rep swalwelll', 'wango tango', 'british isles', 'ufc light heavyweight champion daniel cormier', 'nkorea', 'ukranian', 'also-holloway', 'american christians', 'joe silva', 'bosnia', 'hallelujah', "it's always sunny in philadelphia", 'anglo celtic', 'violet', 'jenga', 'bill nye', 'kate bush', 'hosue republicans', 'health care act', 'jordan fisher', 'obamagate', 'ryan gosling', 'rep schiff', 'this town', 'sofia carson', 'brexited', 'rodgriguez', 'democratic party', 'fisa court', 'jeff sessions', 'limousine', 'american health care act', 'vlad putin', 'bloods', 'ostriches', 'u.s. strike', 'north cork', 'romania', 'edgar holloway', 'islamic', 'arab', 'judy', 'sophie turner', 'fisa/fisc', 'alvarez', 'senate gop', 'health care law', 'nazi', 'chechnya', 'united states', 'juno mission', 'salvador sobral', 'michigan', 'djt', 'i want candy', 'alex caceres', 'lincoln park', 'urals', 'gamebread', 'jason blossom', 'ohio', 'geli', 'msm', 'barack obama', 'louis', 'richie', 'snl', 'ptsd', 'haille steinfeld', 'dark horse', 'jason chaffetz', 'trumpland', 'antisemitism', 'russians', 'english', 'centrist', 'lynch', 'stella', 'japanese high school', 'officer william stacy', 'donald trump', 'dave matthews', 'yodeling', 'comney', 'norway', 'joevin jones', 'acting atty general', 'south america', 'risacea', 'gamebredfighter', 'pbo', 'jurassic world', 'jessica andrade', 'hillary clinton', 'nathan trent', 'mlk jr', 'canadian', 'arn anderson', 'scary clown cars', 'msnbc', 'jim clyburn', 'rachel', 'doj', 'coloradans', 'luisa', 'superior spa', 'breitbarters', "let's go crazy", 'cormier', 'albert einstein', 'wapo', 'lenovo', 'panthers', 'portugal', 'krzysztof jotko', 'shadow boxing', 'j.j. watt', 'democrat party', 'fox news', 'france', 'jorge masvidal', 'spring', 'britain', 'north america', 'lincoln', 'jfc', 'trump-putin', 'the arc', 'adam levine', 'moto x4', 'siri', 'carlos condit', 'netanyahu', 'u.k', 'google project tango', 'diane abbott', 'christ', 'obama ck', 'buzina', 'amrican', 'bbc news', 'progressives', 'breitbart', 'ukraine', 'us senate', 'republican fbi director comey', 'katy perry', 'payno', 'arya stark', 'kendrick lamar', 'united states foreign intelligence surveillance court', 'nialler', 'bruce buffer', 'jds', 'spanish', 'b.j.penn', 'pagie', 'gamebred', 'lynch/obama/rice', 'gop', 'messenger', 'wv', 'brazillians', 'tmt', 'chris hayes', 'niam', 'joanna jedrzejczyk', 'brazil', 'pro abolotion', 'president trump', 'sam clovis', 'cowboys', 'jim crow', 'dos santos', 'matt brown', 'syria', 'whittaker', 'euros', 'bryce harper', 'puppet master', 'kiev', 'justice department', 'imperialism', 'wcs', 'tom clancy', 'gen. flynn', 'oaklettes', 'scaarface', 'bon appetit', 'india', 'fitch', 'mcdonalds', 'gopher', 'mike flynn', 'frankie edwards', 'gameb', 'barfy cam', 'middle east', 'acha', 'superbowl', 'house democrats', 'white house', 'greg leppert', 'hpn', 'twood', 'star wars', 'mike dean', 'vitalii sediuk', 'david branch', 'irish', 'stoke greyson', 'jason knight', 'ahca', 'woodley', 'eddie alvarez', 'trumpcare', 'gigi hadid', 'washington post', 'manafort', 'ceo', 'damien maia', 'poland', 'raccoon gosha', 'eric allen bell', 'james comey', 'flynn', 'jackson wink', 'comrade comey', 'bad things', 'jd', 'nunez', 'mmafighting', 'family services', 'san bernardino', 'enforcer', 'jesus christ', 'july', 'un secgen', 'swedens', 'europeans', 'mexican', 'sims city', 'australian', 'svoboda', 'sowell', 'isil', 'jimmy fallon', 'lee lin', 'solar system', 'simpsons', 'lucie jones', 'africans', 'hybrid theory', 'tj', 'nazis', 'dr.king', 'election day', 'bradford', 'bidet', 'christianity', 'mcgregor', 'hansel robles', 'gop health bill', 'jolene', 'masvidal maia', 'dolly parton', 'red pill', 'haim', 'vladimir', 'zayn', 'eminem', 'camila cabello', 'dustin poirier', 'weiner', 'avril lavigne', 'australians', 'maxine waters', 'bill clinton', 'scottish', 'holocaust centers', 'manel navarro', 'wnyers moc', 'french', 'house oversight chair', 'dear white people', 'super cup', 'frankieedgar', 'moscow', 'wrestlemania', 'stoke ohio high school', 'cbo', 'dems', 'michelle', 'mccanns', 'gentrification', 'savior', 'eurovision song contest', 'fourth reich', 'pro-life', 'jamala', 'floridans', 'brazilian', 'gauteng', 'marine', 'sjw', 'aussie', 'panther', 'john fugelsang', 'mussolini', 'austrian', 'rokita', 'u.s', 'iran deal', 'damian maia', 'serbia', 'grand ole putin party', 'kayla', 'collabs', 'rep. joe kennedy', 'florida', 'hold tight', 'jorge "gamebread" masvidal', 'ukrainian', 'canada', 'arriba', 'pepsi', 'meia', 'womd', 'germany', 'south africa', 'paul ryan', 'miah', 'roger pontare', 'christian', 'buzzfeed germany', 'ukrainne', 'hillary', 'nina', 'canelo', 'oleks skichko', 'le pen', 'spurs', 'devin nunes', 'cyprus', 'muslim', 'pro-birth', 'chester', 'ruslana', 'colonialism', 'imri', 'lisbon', 'big homie stipe', 'senate republicans', "o'care", 'george soros', 'ufc hall of fame', 'prince kushner', 'antarctica', 'bahamas', 'taput', 'jorge', 'mother russia', 'finnish', 'affordable care act', 'german', 'asians', 'bulgarian', 'hailee steinfeld', 'andrew mccabe', 'libnazi', 'mt. everest', 'gitmo', 'brexir', 'mendes', 'mexico', 'niall horan', 'maia. linking park', 'medicaid', 'authoritarian kleptocracy', 'ronaldo', 'jews', 'luhan', "donna d'erri", 'hitler', 'bobby ryan', 'dnc', 'san diego', 'brasil', 'dreamworks', 'h8', 'civil rights laws', 'maryland', 'champions league', 'rick story', 'zionist', 'wee bum', 'alessia cara', 'switzerland', 'la la land', 'gong show', 'steele', 'wikipedia', 'tokio hotel', 'merrill lynch', 'ivanka', 'striker', 'christmas', 'hocaust centers', 'martian', 'bush', 'wp', 'mgk', 'sheila jackson', 'ariel g', 'hosen schlange', 'ag sessions', 'joe-jitsu', 'frankie', 'oil deals', 'harry cantando', 'slow hands', 'e.t. bon appétit', 'ncah', 'boa constrictor', 'coulter', 'club world cup', 'baby elephant', 'hispanics', 'bev hills', 'tillerson', 'jacare souza', 'real madrid', 'christians', 'universal health care', 'michael savage', 'machine gun kelly', 'bsb', 'muslims', 'azerbaijan', 'henley', 'janesville', 'rosneft', 'spaniard', 'june', 'we cant stop', 'lego', 'ann courter', 'darth vader', 'do joe jonas', 'libery university', 'adams', 'mira', 'greece', 'bulgaria', 'holloway', 'whitehouse', 'foxnews', 'conor mcgregor', 'emri', 'soviet russia', 'andy biggs', 'moldova', 'rotherham', 'liberty university', 'iaquinta', 'theresa may', 'vova ostapchuk', 'rose garden', 'leeds bradford airport', 'haiku', 'warriors', 'normila', 'holy father', 'timur m', 'trousersnake', 'martin luther king', 'salvo', 'eddie', 'vets', 'the mich stepping stones daily', 'congressional gop', 'thatcher', 'campaign manager manaford', 'romani', 'george', 'reconstruction south', 'new york times', 'messer', 'liam viendo', 'cuban', 'martin luther king jr', 'bowie', 'adele', 'rashad coulter', 'sherman', 'ufc 211', 'vienna', 'google', 'arizona', 'ariel winter', 'petra', 'susan rice', 'disney', "destiny's child", 'affirmative action', 'el joven diario', 'congressional house', 'macron', 'bon appétit', 'aussies', 'asthma', 'sean spicer', 'russias', 'chester bennington', 'it security', 'twilight', 'baseball', 'diaz', 'onuka', 'spain', 'clintons', 'chucklevision', 'meu deus', 'pastorjerry', 'swedish', 'darrell issa', 'wonder world tour', 'trump tower', 'chris pratt', 'hrw', 'the sleep inducing backpack', 'mississippi mean', 'justin timberlake']

        filtered_level=[]
        level_holder=[]
        for goodcandidates in good_candidates:
            filtered_level.clear()
            for good_candidate in goodcandidates:
                if(good_candidate in my_list ):
                    filtered_level.append(good_candidate)
            level_holder.append(copy.deepcopy(filtered_level))


        good_candidates=level_holder


        annotations= column_annot_holder

        filtered_level_annot=[]
        level_holder_annot=[]
        for goodcandidates in annotations:
            filtered_level_annot.clear()
            for good_candidate in goodcandidates:
                if(good_candidate in my_list ):
                    filtered_level_annot.append(good_candidate)
            level_holder_annot.append(copy.deepcopy(filtered_level_annot))

        annotations=level_holder_annot

        self.annotationnn=annotations
        ...
        if(len(good_candidates)>0):
            for idx,val in enumerate(annotations):
                ...
                self.opencalais_true_positive_mentions.append(true_positive_line)
            ...
            if(state_of_art=="calai_candidates"):
                tweet_ids_df.to_csv("calai_results.csv", sep=',', encoding='utf-8')


    def getAnnot_whole(self):
        return self.annots 
    ...
    def set_column_for_candidates_in_incomplete_tweets(self,candidate_featureBase_DF,input_to_eval):
        ...
        input_to_eval.to_csv("maia_check.csv", sep=',', encoding='utf-8')
    def get_annotation(self,z_score_threshold,input_to_eval):
        annotations2d= input_to_eval['annotation'].tolist()

        annotations_flat=[]
        for annotations in annotations2d:
            annotations_flat=annotations_flat+annotations

        annotations_flat=list(set(annotations_flat))
        return annotations_flat

    def calculate_tp_fp_f1(self,z_score_threshold,input_to_eval):

        self.annots=input_to_eval['annotation'].tolist()
        ...
        if(len(good_candidates)>0):
            for idx,val in enumerate(annotations):
                ...
                #print(idx,false_negative_line)
                true_positive_line=[val2 for val2 in val if val2 in good_candidates[idx]]
                # true_positive_line_experiment=[(idx,val2) for val2 in val if val2 in good_candidates[idx]]
                
                self.our_system_true_positive_mentions.append(true_positive_line)
    ...
    def extract(self,TweetBase,CTrie,phase2stopwordList):
        ...
        if(self.counter==0):
            ...
            self.accuracy_vals=[]
            self.opencalais_true_positive_mentions=[]
            self.our_system_true_positive_mentions=[]
    ...
    def getOpenCalaisMentions(self):
        return self.opencalais_true_positive_mentions

    def getOurSystemMentions(self):
        return self.our_system_true_positive_mentions

    def getAnnots(self):
        return self.annotationnn
