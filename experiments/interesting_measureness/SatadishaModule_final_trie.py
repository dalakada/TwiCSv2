...
class SatadishaModule():
    def calculate_recall(self,input_to_eval):
        ...
        for idx,val in enumerate(annotations):
            ...
            total_cws=total_cws+len(good_candidates[idx])
        ...
        recall=true_positive_count_IPQ/total_mention_count_IPQ
        tp_count=0
        tm_count=0
        fp_count=0
        fn_count=0
    ...
    def calculate_support(self,input_to_eval):
        ...
        support=true_positive_count_IPQ/total_cws
        tp_count=0
        tm_count=0
        fp_count=0
        fn_count=0
