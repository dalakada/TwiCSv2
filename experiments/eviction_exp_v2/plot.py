...
tweets=pd.read_csv("final_converted_tweets.csv",sep =',')

tweets=tweets[tweets.current_minus_entry>0]

print(tweets['current_minus_entry'])
tweets.groupby(["current_minus_entry"]).size().plot(alpha=0.5)
