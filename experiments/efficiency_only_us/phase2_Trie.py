...
class EntityResolver ():
    ...
    def set_column_for_candidates_in_incomplete_tweets(self,candidate_featureBase_DF,input_to_eval):
        ...
        for sentence_level in debug_candidates_label_list:
            ...
            candidates_filtered_g_labeled.append(copy.deepcopy(len(row_level_candidates)))
        ...
        # input_to_eval.to_csv("to_test_tf.csv", sep=',', encoding='utf-8')




    def calculate_tp_fp_f1(self,z_score_threshold,input_to_eval,eviction_parameter):
